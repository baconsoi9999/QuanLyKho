package com.example.quanlykho.chi_tiet_hoa_don.adapter;
...
public class CTHDAdapter extends RecyclerView.Adapter<CTHDAdapter.Holder> {
    ...
    class Holder extends RecyclerView.ViewHolder{
        ...
        public void bind(int position){
            ...
            if(vatTu instanceof CTHoaDon){
                CTHoaDon cthd = (CTHoaDon) vatTu;
                base_title_vattu.setText(cthd.getSoHD()+"_"+cthd.getMaVT()+"_"+cthd.getSoLuong());
            }
        }
    }
